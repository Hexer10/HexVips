...
public void OnPluginStart()
{
	...
	cv_VipJoinMessage = AutoExecConfig_CreateConVar("sm_VipJoinMessage", "1", "Enable join messages? (Check Translations)");
...
void vmenu(int client) //MENU
{
	...
	{
		AddMenuItemFormat(menu, "Double", ITEMDRAW_DEFAULT, "%t", "Menu_Double");
	}
